...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/home/lijun/net-snmp-5.9.3/out' '--disable-manuals' '--disable-snmptrapd-subagent' '--disable-ipv6' '--disable-scripts' '--enable-mini-agent' '--with-mib-modules=notification agentx' '--disable-embedded-perl' '--with-perl-modules' '--with-default-snmp-version=3' '--with--sys-location=China' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/var/net-snmp' 'PKG_CONFIG_PATH=/opt/rh/devtoolset-8/root/usr/lib64/pkgconfig'"
...
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/home/lijun/net-snmp-5.9.3/out/share/snmp/mibs"
...
#define PACKAGE_STRING "Net-SNMP 5.9.3"
#endif
...
#define NETSNMP_DEFAULT_MIBS ":SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:SNMP-NOTIFICATION-MIB:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-TARGET-MIB:SNMPv2-TM"
...
#define SNMPLIBPATH "/home/lijun/net-snmp-5.9.3/out/lib/snmp"
#define SNMPSHAREPATH "/home/lijun/net-snmp-5.9.3/out/share/snmp"
#define SNMPCONFPATH "/home/lijun/net-snmp-5.9.3/out/etc/snmp"
#define SNMPDLMODPATH "/home/lijun/net-snmp-5.9.3/out/lib/snmp/dlmod"
